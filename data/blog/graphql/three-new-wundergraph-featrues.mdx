...
draft: false
images: ['/static/images/wundergraph/graphql_wudnergraph_new_features.png']
...
![developer using restQL in confusion](public/static/images/wundergraph/graphql_wudnergraph_new_features.png)
