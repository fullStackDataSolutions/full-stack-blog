...
**Photo Description**: A screenshot showing the Control Plane's security settings.
...
![A dashboard displaying real-time security telemetry in Cosmo](public/static/images/wundergraph/telemetry.png)
